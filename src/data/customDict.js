...
许志彰 许志彰 [xu3 zhi4 zhang1] /Xu Zhi Zhang (name)/
李丰名 李丰名 [li3 feng1 ming2] /Li Feng Ming (name)/
周淑真 周淑真 [zhou1 shu1 zhen1] /Zhou Shu Zhen (name)/
黄如君 黄如君 [huang2 ru2 jun1] /Huang Ru Jun (name)/
